...
public class AlarmOnActivity2 extends AppCompatActivity implements LocationUtils.OnLocationListener, WeatherUtils.OnWeatherListener {
    Ringtone ringtone;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alarm_on_2);
        buttonAlarmOff = findViewById(R.id.button_alarm_off2);
        ...
        buttonAlarmOff.setOnClickListener(v -> {
            if (count < 10) {
                ...
                final float xMin = 200, xMax = 500;
                final float yMin = 400, yMax = 900;
                ...
                Intent i1 = new Intent(getApplicationContext(), NotesActivity.class);

                String text = "It's your notes! Don't forget to read them!";
                Toast.makeText(AlarmOnActivity2.this, text, Toast.LENGTH_LONG).show();
                startActivity(i1);

                if (notesAmount != 0) {
                    i1 = new Intent(AlarmOnActivity2.this, NotesActivity.class);
                    text = "Now you have " + notesAmount + " notes! Dont forget to read them!";
                    Toast.makeText(AlarmOnActivity2.this, text, Toast.LENGTH_LONG).show();
                } else {
                    i1 = new Intent(AlarmOnActivity2.this, AlarmActivity.class);
                }
                startActivity(i1);
                finish();
            }
    ...
    public void onLocationReceived(String city) {
        if (city != null && !city.isEmpty()) WeatherUtils.searchWeather (city, this, getApplicationContext());
    }
    ...
    public void onWeatherReceived(WeatherData weatherData) {
        switch (weatherData.getDescription()) {
            ...
            case "moderate rain": //умеренный дождь
                ...
                break;
            case "snowy": //Не {CENSORED} снег а снежочек :3
        ...
        if (new Date().getHours() >= 17 || new Date().getHours() <= 6) {
            bg.setImageResource(R.drawable.__night_bg);
            buttonAlarmOff.setImageResource(R.drawable.__night_but);
        }
    }
}
